...
class EncryptedDatabaseTest {
    ...
    private val TEST_DB_NAME = "test_encrypted_database.db"
    private val TEST_PASSPHRASE = "test_super_secret_passphrase".toByteArray()
    ...
    fun createDb() {
        ...
        val factory = SupportOpenHelperFactory(TEST_PASSPHRASE)
    ...
    @Test
    fun testEncryptedDatabaseCrudOperations() = runBlocking {
