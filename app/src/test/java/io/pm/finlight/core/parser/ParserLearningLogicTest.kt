...
class ParserLearningLogicTest : BaseSmsParserTest() {
    ...
    @Test
    fun `test_categoryLearning_usesOriginalMerchantName`() =
        runBlocking {
            // ARRANGE
    ...
    @Test
    fun `test_renameRule_isAppliedToFinalMerchantName`() =
        runBlocking {
            // ARRANGE
    ...
    // =================================================================================
    @Test
    fun `test_combinedLogic_learnsCategoryBeforeApplyingRename`() =
        runBlocking {
            // ARRANGE
