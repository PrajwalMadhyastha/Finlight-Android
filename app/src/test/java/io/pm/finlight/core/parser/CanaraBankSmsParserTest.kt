...
class CanaraBankSmsParserTest : BaseSmsParserTest() {
    @Test
    fun `test parses Canara Bank credit with 'CREDITED to your account' format`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses Canara Bank credit with 'has been CREDITED to your account'`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses Canara Bank credit with 'has been CREDITED to your A_c'`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses Canara Bank debit and account`() =
        runBlocking {
            setupTest()
