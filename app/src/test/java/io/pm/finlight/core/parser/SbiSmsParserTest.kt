...
class SbiSmsParserTest : BaseSmsParserTest() {
    ...
    @Test
    fun `test parses SBI UPI expense with 'frm' keyword`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI salary credit with 'has credit' keyword`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI debit with 'debited by' keyword`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI debit with 'has a debit by transfer' keyword`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI credit with 'has a credit by Transfer' format`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test correctly parses SBI UPI debit, account, and merchant`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI Debit Card AMC and account`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI transfer and account`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI credit with Acc No and account`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI ATM withdrawal and account`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI debit with 'Your A_c' keyword`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI income with 'Your A_C' format`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI debit with 'Towards cash payment'`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI Credit Card without the word 'with'`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI UPI credit with no merchant`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test parses SBI credit with account at start and bank at end`() =
        runBlocking {
            setupTest()
