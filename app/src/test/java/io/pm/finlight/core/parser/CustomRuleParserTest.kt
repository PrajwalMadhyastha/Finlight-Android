...
// TODO: Add tests for custom, user-defined parsing rules here.
class CustomRuleParserTest : BaseSmsParserTest() {

    @Test
    fun `placeholder_for_custom_rules`() {
        // This is a placeholder to make the test class valid.
        // Actual tests for custom SMS parsing rules will be added in the future.
        assertTrue(true)
    }
}
