...
class IgnoreRuleParserTest : BaseSmsParserTest() {
    ...
    @Test
    fun `test ignores HDFC NEFT credit message`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores credit card payment confirmation`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores bharat bill pay confirmation`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores message with user-defined ignore phrase`() =
        runBlocking {
    ...
    @Test
    fun `test ignores Paytm Wallet payment`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores declined transaction`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores AutoPay mandate setup`() =
        runBlocking {
            setupTest(
                ignoreRules =
                    listOf(
    ...
    @Test
    fun `test ignores HDFC payee modification alert`() =
        runBlocking {
    ...
    @Test
    fun `test ignores Airtel recharge credited confirmation`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores insurance policy conversion alert`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores failed payment notification`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores bonus points notification`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Delhivery authentication code message`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Amazon gift card voucher code message`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Gruha Jyoti scheme application message`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Bhima promotional message`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Navi Mutual Fund unit allotment message`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores SBI Credit Card e-statement notification`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores Orient Exchange order received confirmation`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores MakeMyTrip booking confirmation`() =
        runBlocking {
    ...
    @Test
    fun `test ignores promotional wallet credit message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores HDFC Welcome Kit delivery confirmation`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores suspected spam Rummy message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores informational NEFT sent message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores informational NEFT credited to beneficiary message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores Zepto refund processed message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores promotional birthday offer`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores SBI Card delivery confirmation`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores promotional offer reminder`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores payee modification without the word 'a'`() =
        runBlocking {
            val ignoreRules = DEFAULT_IGNORE_PHRASES.filter { it.isEnabled }
            setupTest(ignoreRules = ignoreRules)
    ...
    @Test
    fun `test ignores RTGS informational message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores Trends Footwear points message`() =
        runBlocking {
            setupTest(ignoreRules = DEFAULT_IGNORE_PHRASES)
    ...
    @Test
    fun `test ignores SBIL renewal premium notice`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Bank of Baroda email added confirmation`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Jio eSIM activation instructions`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Godrej real estate advertisement`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Lok Adalat Notice`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Fixed Deposit closure message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Porter wallet credit message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores bob World maintenance message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Apollo Pharmacy promotional message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores JioHealthHub informational message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores India Post delivery message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Canara Bank cheque book delivery message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Practo family member message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores JioTV promotional message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores My11Circle promotional message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores 'Received with thanks' receipt message`() =
        runBlocking {
    ...
    @Test
    fun `test ignores Jio activation message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Bank of Baroda informational message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores SBI Life premium payment message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores DICGCI insurance claim message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores MyGovt RT-PCR sample message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores IndiaFirst premium debit notification`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores SBI OTP message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Samsung order confirmation`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores NSDL insurance policy credit`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores VFS visa application receipt`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Lenskart refund with missing amount`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Cashify get paid message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores CDSL shares credit message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Protean NSDL PRAN contribution message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores NSE cash equity registration message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC credit card payment received message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores RBI Ombudsman informational message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Units against Voluntary Contribution message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores delivered by DELHIVERY message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores has been deactivated message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Simpl bill payment message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores cashless claim message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores MoRTH receipt notification`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC address change request`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores Axis Bank UPI mandate request`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC future debit alert`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores informational NEFT credit to beneficiary`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores passbook contribution received message`() =
        runBlocking {
            setupTest() // Uses the updated default ignore rules
    ...
    @Test
    fun `test ignores share bonus allotment message`() =
        runBlocking {
    ...
    @Test
    fun `test ignores HDFC E-Mandate message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC Reward Points credit message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC future debit message`() =
        runBlocking {
            setupTest()
            val smsBody =
                "Alert:\n" +
    ...
    @Test
    fun `test ignores ICICI Credit Card Statement`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores HDFC split EMI`() =
        runBlocking {
            setupTest()
            val smsBody =
                "Hurry! Split Rs.1234 spent on HDFC\n" +
    ...
    @Test
    fun `test ignores FASTag Annual Pass Message`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores RTGS Initiation`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores ICICI transaction confirmation`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores pending transaction with is under process`() =
        runBlocking {
            setupTest()
    ...
    @Test
    fun `test ignores transaction with will be credited`() =
        runBlocking {
            setupTest()
