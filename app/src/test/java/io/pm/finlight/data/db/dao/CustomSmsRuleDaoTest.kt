...
class CustomSmsRuleDaoTest {
    ...
    @Test
    fun `getAllRules returns rules ordered by priority descending`() =
        runTest {
            // Arrange
            val ruleLowPriority =
            ...
            val ruleMidPriority =
                CustomSmsRule(id = 3, triggerPhrase = "mid", priority = 5, sourceSmsBody = "", merchantRegex = null, amountRegex = null, accountRegex = null, merchantNameExample = null, amountExample = null, accountNameExample = null)
    ...
    @Test
    fun `getAllRulesList returns a simple list`() =
        runTest {
            // Arrange
            val rules =
                listOf(
    ...
    fun `getRuleById returns correct rule`() =
        runTest {
            // Arrange
            val rule =
                CustomSmsRule(id = 1, triggerPhrase = "test", priority = 1, sourceSmsBody = "", merchantRegex = null, amountRegex = null, accountRegex = null, merchantNameExample = null, amountExample = null, accountNameExample = null)
    ...
    fun `update modifies rule correctly`() =
        runTest {
            // Arrange
            val rule =
                CustomSmsRule(id = 1, triggerPhrase = "old", priority = 1, sourceSmsBody = "", merchantRegex = null, amountRegex = null, accountRegex = null, merchantNameExample = null, amountExample = null, accountNameExample = null)
            customSmsRuleDao.insert(rule)
    ...
    @Test
    fun `deleteAll removes all rules`() =
        runTest {
            // Arrange
            val rules =
                listOf(
