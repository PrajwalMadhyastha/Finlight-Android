...
class TripDaoTest {
    ...
    @Test
    fun `getAllTripsWithStats calculates totalSpend and transactionCount correctly`() =
        runTest {
            // Arrange
            tripDao.insert(
                Trip(
            ...
            val tx3Id =
                ...
                ).toInt() // Should be ignored from total spend
    ...
    @Test
    fun `getAllTripsWithStats handles split transactions correctly`() =
        runTest {
            // Arrange
            tripDao.insert(
                Trip(
    ...
    @Test
    fun `isTagUsedByTrip returns correct count`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `insertAll and deleteAll work correctly`() =
        runTest {
            // Arrange
            val trips =
                listOf(
                    ...
                    Trip(
                        ...
                        startDate = 3L,
                        endDate = 4L,
                        tagId = tagDao.insert(Tag(name = "T2")).toInt(),
                        tripType = TripType.DOMESTIC,
                        currencyCode = null,
                        conversionRate = null,
                    ),
    ...
    @Test
    fun `getTripByTagId returns correct trip`() =
        runTest {
            // Arrange
            tripDao.insert(
                Trip(
    ...
    @Test
    fun `getTripWithStatsById returns correct trip`() =
        runTest {
            // Arrange
            val tripId =
                tripDao.insert(
    ...
    @Test
    fun `deleteTripById removes the trip`() =
        runTest {
            // Arrange
            val tripId =
                tripDao.insert(
