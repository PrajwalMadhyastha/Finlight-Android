...
class IgnoreRuleDaoTest {
    ...
    @Test
    fun `inserting duplicate pattern with different case is ignored`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `deleteDefaultRules only removes default rules`() =
        runTest {
            // Arrange
            ignoreRuleDao.insertAll(
                listOf(
    ...
    @Test
    fun `getAllList returns all rules as a list`() =
        runTest {
            // Arrange
            val rules =
                listOf(
    ...
    @Test
    fun `getEnabledRules returns only enabled rules`() =
        runTest {
            // Arrange
            val rules =
                listOf(
