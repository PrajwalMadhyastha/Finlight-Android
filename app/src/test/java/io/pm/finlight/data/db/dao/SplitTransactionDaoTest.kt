...
class SplitTransactionDaoTest {
    ...
    @Test
    fun `getSplitsForParent returns correctly joined details`() =
        runTest {
            // Arrange
            val splits =
                listOf(
    ...
    @Test
    fun `getSplitsForParentSimple returns correct simple details`() =
        runTest {
            // Arrange
            val splits =
                listOf(
    ...
    @Test
    fun `getAllSplits and deleteAll work correctly`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `update modifies a split transaction`() =
        runTest {
            // Arrange
            splitTransactionDao.insertAll(
                listOf(SplitTransaction(id = 1, parentTransactionId = parentId, amount = 100.0, categoryId = 1, notes = "Old Note")),
            )
    ...
    @Test
    fun `deleteById removes the correct split`() =
        runTest {
            // Arrange
            splitTransactionDao.insertAll(
                listOf(
    ...
    @Test
    fun `deleteSplitsForParent removes all children of a transaction`() =
        runTest {
            // Arrange
            val parentId2 =
