...
class MerchantMappingDaoTest {
    ...
    @Test
    fun `insert and getMappingForSender retrieves correct mapping`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getMappingForSender returns null for unknown sender`() =
        runTest {
            // Arrange
            val mapping = MerchantMapping(smsSender = "AM-HDFCBK", merchantName = "HDFC Bank")
            merchantMappingDao.insert(mapping)
    ...
    @Test
    fun `insert duplicate sender overwrites existing mapping`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `insertAll inserts multiple mappings correctly`() =
        runTest {
            // Arrange
            val mapping1 = MerchantMapping(smsSender = "AM-HDFCBK", merchantName = "HDFC Bank")
