...
class SmsParseTemplateDaoTest {
    ...
    @Test
    fun `inserting template with same composite primary key is ignored`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `inserting template with different composite key is successful`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getTemplatesBySignature returns only matching templates`() =
        runTest {
            // Arrange
            val templates = listOf(template1, template2, template3)
            smsParseTemplateDao.insertAll(templates)
    ...
    @Test
    fun `getTemplatesBySignature is case insensitive`() =
        runTest {
            // Arrange
            val templates = listOf(template1, template2, template3)
            smsParseTemplateDao.insertAll(templates)
