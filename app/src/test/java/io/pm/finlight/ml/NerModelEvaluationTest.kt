...
class NerModelEvaluationTest {
    ...
    private val evalCases: List<EvalCase> =
        listOf(
            // ---- HDFC ----
            EvalCase(
                "HDFC",
            ...
            EvalCase(
                "HDFC",
                "[JD-HDFCBK-S] Spent Rs.388.19 On HDFC Bank Card 9922 At ..MC DONALDS_ on2025-06-22:08:01:24.Not You> To Block+Reissue Call 18002323232/SMS BLOCK CC 9922 to 123098123",
                "JD-HDFCBK",
                388.19,
                "MC DONALDS",
                "HDFC Bank Card - xx9922",
                "expense",
            ),
            EvalCase(
                "HDFC",
            ...
            EvalCase(
                "HDFC",
                "HDFC Bank: Rs 10,000.00 credited to a/c XXXXXX1234 on 15-Jul-25 by a]c linked to VPA ravi@icici (UPI Ref No 518700000000).",
                "AM-HDFCBK",
                10000.0,
                "ravi@icici",
                null,
            ...
            EvalCase(
                "HDFC",
                "Rs 1,500.00 debited from a/c **4321 on 12-07-25 to VPA swiggy@hdfcbank (UPI Ref No 519400000000).",
                "AM-HDFCBK",
                1500.0,
                "swiggy@hdfcbank",
                null,
            ...
            EvalCase(
                "HDFC",
                "HDFC Bank CREDIT Card ending 8967 - Txn of Rs.599.00 on 14-07-25 at NETFLIX.COM.Info:NETFLIX.COM.Not you?Call 18002586161/SMS BLOCK CC 8967 to 7308080808",
                "AM-HDFCBK",
                599.0,
                "NETFLIX.COM",
                null,
            ...
            EvalCase(
                "HDFC",
                "Update: HDFC Bank A/c XX1234 credited with Rs. 25,000. NEFT Ref SBIN825072300003211 on 23-JUL-25.",
                "AM-HDFCBK",
                25000.0,
                "NEFT Ref SBIN825072300003211",
                null,
                "income",
            ),
            // ---- ICICI ----
            EvalCase(
                "ICICI",
                "ICICI Bank Acc XX244 debited Rs. 8,700.00 on 02-Aug-25 InfoACH*ZERODHA B.Avl Bal Rs. 3,209.31.To dispute call 18002662 or SMS BLOCK 646 to 9215676766",
                "DM-ICIBNK",
                8700.0,
                "ACH*ZERODHA B",
                null,
            ...
            EvalCase(
                "ICICI",
                "ICICI Bank Acct XX823 debited for Rs 240.00 on 28-Jul-25; DAKSHIN CAFE credited. UPI: 552200221100. Call 18002661 for dispute. SMS BLOCK 823 to 123123123",
                "DM-ICIBNK",
                240.0,
                "DAKSHIN CAFE",
                null,
            ...
            EvalCase(
                "ICICI",
                "Dear Customer, Acct XX823 is credited with Rs 6000.00 on 26-Jun-25 from GANGA MANGA. UPI:5577822323232-ICICI Bank",
                "QP-ICIBNK",
                6000.0,
                "GANGA MANGA",
                null,
            ...
            EvalCase(
                "ICICI",
                "ICICI Bank Account XX823 credited:Rs. 1,133.00 on 01-Jul-25. Info NEFT-HDFCN5202507024345356218-. Available Balance is Rs. 1,858.35.",
                "VM-ICIBNK",
                1133.0,
                "NEFT-HDFCN5202507024345356218-",
                null,
                "income",
            ),
            EvalCase(
                "ICICI",
                "Dear Customer, your ICICI Bank Account XX508 has been credited with INR 328.00 on 30-Aug-22. Info:ACH*RELIANCEINDUSTRIES*000000000002. The Available Balance is INR 42,744.71.",
                "DM-ICIBNK",
                328.0,
                "ACH*RELIANCEINDUSTRIES*000000000002",
                null,
                "income",
            ),
            EvalCase(
                "ICICI",
                "INR 7,502.00 spent on ICICI Bank Card XX8011 on 31-Aug-22 at Amazon. Avl Lmt: INR 2,51,545.65. To dispute,call 18002662/SMS BLOCK 8011 to4082711530",
                "DM-ICIBNK",
                7502.0,
                "Amazon",
                null,
            ...
            EvalCase(
                "ICICI",
                "INR 782.00 spent using ICICI Bank Card XX1001 on 29-Jul-25 on IND*Amazon.in -. Avl Limit: INR 4,94,835.00. If not you, call 1800 2662/SMS BLOCK 1001 to4082711530.",
                "DM-ICIBNK",
                782.0,
                "IND*Amazon.in",
                null,
            ...
            EvalCase(
                "ICICI",
                "Your account has been successfully debited with Rs 149.00 on 17-Sep-22 towards JioHotstar for Autopay AutoPay, RRN 506941017769-ICICI Bank.",
                "DM-ICIBNK",
                149.0,
                "JioHotstar",
                null,
            ...
            EvalCase(
                "ICICI",
                "ICICI Bank Acct XX123 debited for Rs 600.00 on 20-Sep-25; KOMALSHREE BHAT credited. UPI:562098765250. Call 18002662 for dispute. SMS BLOCK 646 to 9215676766.",
                "DM-ICIBNK",
                600.0,
                "KOMALSHREE BHAT",
                null,
            ...
            EvalCase(
                "SBI",
                "Dear UPI user A/C X9876 debited by 150.0 on date 25Jul25 trf to Mr.RAJESH Ref No 552512345678. If not u? call 1800111109. -Loss Rs 0 SBI",
                "AM-SBI",
                150.0,
                "Mr.RAJESH",
                null,
            ...
            EvalCase(
                "SBI",
                "Your a/c no. XXXXXXXX1234 is credited by Rs.2,500.00 on 20-Aug-25 by NEFT-SBIN723072300005. (Bal: Rs.15,600.50). -SBI",
                "AM-SBI",
                2500.0,
                "NEFT-SBIN723072300005",
                null,
                "income",
            ),
            // ---- Axis ----
            EvalCase(
                "Axis",
                "INR 450.00 sent from Axis Bank A/C XX6789 to VPA zomato@icici on 15-Aug-25. UPI Ref:525001234567.",
                "AM-AXIS",
                450.0,
                "zomato@icici",
                null,
            ...
            EvalCase(
                "Axis",
                "INR 1,200.00 received in your Axis Bank A/C XX6789 from VPA salary@hdfcbank on 01-Sep-25. UPI Ref:524401234567.",
                "AM-AXIS",
                1200.0,
                "salary@hdfcbank",
                null,
            ...
            EvalCase(
                "Canara",
                "Rs.300.00 debited from A/C No. XX5678 on 18/08/2025 for UPI-AMAZON-merchant@paytm Bal:Rs.4500.50 -CanaraBank",
                "AM-CANBNK",
                300.0,
                "AMAZON",
                null,
            ...
            EvalCase(
                "Pluxee",
                "Dear User, your Pluxee Card ending 1234 has been debited for Rs.350.00 at DOMINOS on 22-Aug-2025.",
                "AM-PLUXEE",
                350.0,
                "DOMINOS",
                null,
            ...
            EvalCase(
                "Generic",
                "Thank you for using your Debit Card ending 5678 for Rs 899.00 at FLIPKART on 10-Sep-25. If not authorised call 1800-xxx.",
                "AM-BANK",
                899.0,
                "FLIPKART",
                null,
            ...
            EvalCase(
                "Generic",
                "Txn of INR 1,499.00 done on Card ending 9012 at UBER INDIA on 05-Aug-25.",
                "AM-BANK",
                1499.0,
                "UBER INDIA",
                null,
            ...
            EvalCase(
                "Generic",
                "Your account XX3456 has been credited with Rs 5,000.00 from JOHN DOE via IMPS on 12-Sep-25. Ref:525601234567.",
                "AM-BANK",
                5000.0,
                "JOHN DOE",
                null,
    ...
    fun `benchmark NER model against ground truth`() {
        ...
        for (case in evalCases) {
            ...
            val amountMatch =
                if (case.expectedAmount != null && nerAmount != null) {
            ...
            val merchantMatch =
                if (case.expectedMerchant != null && nerMerchant != null) {
            ...
            val accountMatch =
                if (case.expectedAccount != null && nerAccount != null) {
        ...
        val summary =
            buildString {
                ...
                appendLine(
                    "MERCHANT: P=${fmt(
                        merchantP,
                    )}  R=${fmt(merchantR)}  F1=${fmt(merchantF1)}  (TP=$merchantTP FP=$merchantFP FN=$merchantFN)",
                )
                appendLine(
                    "ACCOUNT:  P=${fmt(accountP)}  R=${fmt(accountR)}  F1=${fmt(accountF1)}  (TP=$accountTP FP=$accountFP FN=$accountFN)",
                )
                appendLine()
                ...
                if (mismatches.isNotEmpty()) {
                    ...
                    for (r in mismatches) {
                        ...
                        appendLine(
                            "  Expected: amount=${r.case.expectedAmount}  merchant=${r.case.expectedMerchant}  account=${r.case.expectedAccount}",
                        )
        ...
        csvFile.bufferedWriter().use { w ->
            w.write(
                "bank,verdict,expected_amount,ner_amount,amount_match,expected_merchant,ner_merchant,merchant_match,expected_account,ner_account,account_match,sms_body",
            )
            w.newLine()
            for (r in results) {
    ...
    private fun pct(
        n: Int,
        total: Int,
    ) = if (total > 0) "%.1f%%".format(n * 100.0 / total) else "0.0%"
    ...
    private fun isPythonAvailable(pythonPath: String): Boolean {
        return try {
            val p =
                ProcessBuilder(pythonPath, "-c", "import tensorflow; print('OK')")
