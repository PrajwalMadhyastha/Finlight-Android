...
class ProfileViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `migration does nothing when no profile picture URI is stored in prefs`() = runTest {
    ...
    @Test
    fun `migration does nothing when URI is not in the attachments directory`() = runTest {
    ...
    @Test
    fun `migration does nothing when file in attachments directory does not exist`() = runTest {
    ...
    @Test
    fun `migration moves profile picture from attachments to profile directory`() = runTest {
    ...
    @Test
    fun `saveProfilePictureUri with non-null URI saves file to profile directory`() = runTest {
        // Arrange
        setupDefaultRepo()
        viewModel = ProfileViewModel(application, settingsRepository)
        ...
        assertTrue("Saved path should be inside the profile/ directory",
