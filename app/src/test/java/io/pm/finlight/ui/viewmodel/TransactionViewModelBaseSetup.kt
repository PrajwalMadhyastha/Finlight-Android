...
abstract class TransactionViewModelBaseSetup : BaseViewModelTest() {
    ...
    override fun setup() {
        ...
        whenever(db.transactionQueryDao()).thenReturn(transactionDao)
        whenever(db.transactionWriteDao()).thenReturn(transactionDao)
        whenever(db.transactionAnalyticsDao()).thenReturn(transactionDao)
        whenever(db.transactionReimbursementDao()).thenReturn(transactionDao)
