...
class ReportsViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `allCategories flow emits categories from DAO`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `reportData correctly processes data from repositories`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `selectPeriod updates selectedPeriod state`() =
        runTest {
            // Arrange
            initializeViewModel()
    ...
    @Test
    fun `selectPreviousMonth updates selectedMonth correctly`() =
        runTest {
            // Arrange
            initializeViewModel()
    ...
    @Test
    fun `selectNextMonth updates selectedMonth correctly`() =
        runTest {
            // Arrange
            initializeViewModel()
            val initialMonth = viewModel.selectedMonth.value.get(Calendar.MONTH)
    ...
    @Test
    fun `reportData uses same-period comparison for MONTH period`() =
        runTest {
