...
class TransactionViewModelTest : BaseViewModelTest() {
    ...
    private fun setupDefaultMocks() {
        runTest {
            ...
            whenever(
                transactionRepository.getTransactionDetailsForRange(anyLong(), anyLong(), any(), any(), any()),
            ).thenReturn(flowOf(emptyList()))
            whenever(transactionRepository.getFinancialSummaryForRangeFlow(anyLong(), anyLong())).thenReturn(flowOf(null))
            whenever(
                transactionRepository.getSpendingByCategoryForMonth(anyLong(), anyLong(), any(), any(), any(), any()),
            ).thenReturn(flowOf(emptyList()))
            whenever(
                transactionRepository.getSpendingByMerchantForMonth(anyLong(), anyLong(), any(), any(), any(), any()),
            ).thenReturn(flowOf(emptyList()))
