...
class CurrencyViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `homeCurrency flow emits value from repository`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `saveHomeCurrency calls repository`() =
        runTest {
            // Act
    ...
    @Test
    fun `completeTrip calls repository to save null settings`() =
        runTest {
            // Act
    ...
    @Test
    fun `deleteTrip calls transaction and trip repositories`() =
        runTest {
            // Arrange
            val tripId = 1
            val tagId = 2
    ...
    @Test
    fun `saveActiveTravelPlan for new trip correctly interacts with repositories`() =
        runTest {
            // Arrange
            val newSettings =
                TravelModeSettings(
    ...
    @Test
    fun `updateHistoricTrip correctly interacts with repositories`() =
        runTest {
            // Arrange
            val tripId = 1
            val updatedSettings =
    ...
    @Test
    fun `cancelTrip correctly interacts with repositories`() =
        runTest {
            // Arrange
            val settingsToCancel =
                TravelModeSettings(
                    isEnabled = true,
    ...
    @Test
    fun `loadTripForEditing updates tripToEdit state`() =
        runTest {
            // Arrange
            val tripId = 1
    ...
    @Test
    fun `clearTripToEdit resets tripToEdit state`() =
        runTest {
            // Arrange
            val tripId = 1
            val mockTrip = TripWithStats(tripId, "Test Trip", 1L, 2L, 100.0, 2, 1, TripType.DOMESTIC, null, null)
    ...
    @Test
    fun `saveActiveTravelPlan when updating existing plan correctly removes old tags`() =
        runTest {
            // Arrange
            val oldSettings =
                TravelModeSettings(
    ...
    @Test
    fun `historicTrips flow emits all trips when no travel mode is active`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `historicTrips flow filters out the active trip`() =
        runTest {
            // Arrange
