...
class PendingTransactionsViewModelTest : BaseViewModelTest() {
    ...
    @Test
    fun `pendingTransactions emits from dao`() = runTest {
        // Arrange
    ...
    @Test
    fun `confirmPending confirms transaction and updates rule`() = runTest {
        // Arrange
    ...
    @Test
    fun `confirmPending with custom amount updates amount before confirming`() = runTest {
        // Arrange
        every { transactionDao.getPendingTransactions() } returns MutableStateFlow(emptyList())
        viewModel = PendingTransactionsViewModel(application)
    ...
    @Test
    fun `skipPending skips transaction and increments skip count`() = runTest {
        // Arrange
        every { transactionDao.getPendingTransactions() } returns MutableStateFlow(emptyList())
